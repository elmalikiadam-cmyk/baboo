    ...
    <div className="space-y-2">
      {google && (
        <button
          ...
          disabled={isPending}
          className="flex w-full items-center justify-center gap-2 rounded-full border border-foreground/20 bg-background px-4 py-2.5 text-sm font-medium transition hover:bg-foreground/5 disabled:opacity-50"
        >
          <GoogleMark />

            ...
            <li key={m.id}>
              {showDay && (
                <div className="my-4 text-center">
                  <span className="mono rounded-full bg-foreground/5 px-3 py-1 text-[10px] uppercase tracking-[0.12em] text-muted-foreground">
                    {day}
                  </span>
                </div>
              )}
                ...
                >
                  ...
                  <p
                    className={`mono mt-1 text-[9px] uppercase tracking-[0.1em] ${
                      m.isMine ? "text-background/60" : "text-muted-foreground"
                    }`}
                  >
                    {TIME_FR.format(d)}
                  </p>

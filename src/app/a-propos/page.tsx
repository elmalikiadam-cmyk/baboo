...
export default function AboutPage() {
  return (
    <div>
        ...
        <ul className="grid gap-5 md:grid-cols-2">
          {VALUES.map((v) => (
            <li key={v.n} className="rounded-md border border-border p-7 md:p-9">
              <p className="mono text-[10px] tracking-[0.14em] text-muted">/{v.n}</p>
      ...
      <section className="container py-14 md:py-20">
        <div className="rounded-md bg-midnight p-10 text-cream md:p-16">
          <p className="eyebrow text-cream/60">Rejoindre Baboo</p>
          <h2 className="display-xl mt-3 text-4xl text-cream md:text-5xl">

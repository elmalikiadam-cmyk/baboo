      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1.3fr_1fr]">
        ...
        <aside>
          ...
          {project.leads.length === 0 ? (
            <p className="mt-4 rounded-md border border-dashed border-foreground/25 p-5 text-center text-sm text-muted-foreground">
              Pas encore de demande de brochure.
            </p>
          ) : (
            <ul className="mt-4 space-y-2">
              {project.leads.map((l) => (
                <li key={l.id} className="rounded-md border border-foreground/15 bg-surface p-3">

      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1.3fr_1fr]">
        ...
        <aside>
          ...
          {project.leads.length === 0 ? (
            <p className="mt-4 rounded-md border border-dashed border-border p-5 text-center text-sm text-ink-muted">
            ...
            <ul className="mt-4 space-y-2">
              {project.leads.map((l) => (
                <li key={l.id} className="rounded-md border border-border bg-surface p-3">
                  ...
                  <p className="mt-2 line-clamp-2 text-xs text-ink-muted">« {l.message} »</p>
                </li>
              ))}
            </ul>
          )}
